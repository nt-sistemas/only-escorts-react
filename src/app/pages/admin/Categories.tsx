...
export function AdminCategories() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="mb-2 text-3xl font-bold text-white">Categories Management</h1>
        <p className="text-neutral-400">Create and manage categories from endpoint /admin/category</p>
      ...
      <Card className="border-neutral-800 bg-neutral-900">
        ...
        <CardContent>
          {isLoading && <p className="mb-3 text-sm text-neutral-500">Loading categories from API...</p>}
                  ...
                  <TableRow key={category.id} className="border-neutral-800 hover:bg-neutral-800/50">
                    ...
                    <TableCell className="text-right">
                      <div className="inline-flex gap-2">
                        <Button size="sm" variant="outline" className="border-neutral-700 text-neutral-200" onClick={() => handleEdit(category)}>
